...
final class APIService {
    ...
    func requestMedianHotel(cityID: Int, completion: @escaping (Result<MedianHotelResponseModel, Error>) -> Void) {
        provider.request(.medianHotelRead(cityID: cityID)) { result in
            switch result {
